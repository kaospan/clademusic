import{g as o,i as u,h as i}from"./index-vWAVx6wR.js";import{u as l}from"./useMutation-IuNwCYZa.js";function p(t){return o({queryKey:["playlists",t],queryFn:async()=>{let r=i.from("playlists").select(`
          *,
