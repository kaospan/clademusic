import{h as o,k as u,i}from"./index-uVJjQOkW.js";import{u as l}from"./useMutation-WGDTCfqi.js";function p(t){return o({queryKey:["playlists",t],queryFn:async()=>{let r=i.from("playlists").select(`
          *,
