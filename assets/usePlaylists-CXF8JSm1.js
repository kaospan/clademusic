import{g as o,i as u,h as i}from"./index-BcOb0-Qk.js";import{u as l}from"./useMutation-DGqXFvSn.js";function p(t){return o({queryKey:["playlists",t],queryFn:async()=>{let r=i.from("playlists").select(`
          *,
