import{g as o,i as u,h as i}from"./index-cU2nGgA-.js";import{u as l}from"./useMutation-DHi-jTbO.js";function p(t){return o({queryKey:["playlists",t],queryFn:async()=>{let r=i.from("playlists").select(`
          *,
