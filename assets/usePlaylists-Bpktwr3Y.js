import{g as o,i as u,h as i}from"./index-GNu0OiLQ.js";import{u as l}from"./useMutation-DASysOsK.js";function p(t){return o({queryKey:["playlists",t],queryFn:async()=>{let r=i.from("playlists").select(`
          *,
